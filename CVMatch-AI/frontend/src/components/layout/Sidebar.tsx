import { BarChart3, Briefcase, Settings, TrendingUp, Upload, Users } from 'lucide-react';
    ...
    <div className="fixed left-0 top-0 h-full w-64 bg-slate-900 text-white shadow-xl z-40">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-4">
        <div className="bg-slate-800 rounded-lg p-4">
          <div className="flex items-center gap-3">
            <div className="w-10 h-10 rounded-full bg-emerald-600 flex items-center justify-center font-bold">HR</div>
            <div>
              <p className="font-medium text-sm">HR User</p>
              <p className="text-xs text-slate-400">Recruteur</p>
            </div>
          </div>
        </div>
      </div>
